...
echo "  - UI, backtests, and strategy review run here."
echo "  - For REAL BlackBull balance on Linux, use the MT5 bridge:"
echo "      1) On Windows: .\\scripts\\start-bridge.ps1  (MT5 must be open)"
echo "      2) In .env:     MT5_BRIDGE_URL=http://WINDOWS_IP:8021"
echo "      3) Test:        python scripts/check-bridge.py"
echo "  - Or run the full app on Windows next to MT5."
echo ""
