...
function buildSummaryTable(fields) {
  const rows = [
    ...
    ["Worker Phone", fields.workerPhone],
    ["Worker Email", fields.workerEmail],
    ["Supervised Worker Name", fields.supervisedWorkerName],
    ["Supervised Worker Registration / Licence", fields.supervisedWorkerLicense],
    ["Supervised Worker Phone", fields.supervisedWorkerPhone],
    ["Supervised Worker Email", fields.supervisedWorkerEmail],
    ["Supervision Notes", fields.supervisedWorkerNotes],
